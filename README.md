...
![Typing SVG]([https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F78F1E&center=true&width=600&lines=Welcome+to+Setbian+by+Bhuvanesh+M;A+GUI+tool+for+Debian+System+Configuration](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=FFFFFF&background=3B0A57&center=true&width=600&lines=Welcome+to+Setbian+by+Bhuvanesh+M;A+GUI+tool+for+Debian+System+Configuration))
